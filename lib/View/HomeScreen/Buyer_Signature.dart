...
import 'dart:io';
class Buyer_Signature extends StatefulWidget {
  Buyer_Signature({Key? key}) : super(key: key);

  @override
  _Buyer_SignatureState createState() => _Buyer_SignatureState();
}

class _Buyer_SignatureState extends State<Buyer_Signature> {
  ...
  void _handleSaveButtonPressed() async {
    ...
    if (bytes != null) {
      ...
      commonContoller.BuyerSignatureImage(pngBytes); // Store image in GetX controller
      Get.back();
